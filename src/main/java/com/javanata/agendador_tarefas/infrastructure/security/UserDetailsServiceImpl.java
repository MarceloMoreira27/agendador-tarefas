...
public class UserDetailsServiceImpl {
    ...
    public UserDetails carregaDadosUsuario(String email,String token){
        ...
        UsuarioDTO usuarioDTO = usuarioClient.bucarUsuarioPorEmail(email,token);

        return User
                .withUsername(usuarioDTO.getEmail())//Define o usuário
                .password(usuarioDTO.getSenha())//Define a senha
